...
// convenient to have a camera: similar to threejs!
// abstraction to manage scene sampling with axis aligned cameera
pub struct Camera {
    origin: Point3,
...
// constructs camera with hardcoded values
impl Camera {
    pub fn new(
    lookfrom: Point3, // vector defining plane we 'look from'
    lookat: Point3, // vector defining plane we 'look to'
